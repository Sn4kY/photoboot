...
#montage /tmp/montage3.jpg -border 15 -bordercolor "#ffffff" -density 300 -units PixelsPerInch -geometry +0+0 -gravity north /tmp/montage4.jpg
convert /tmp/montage3.jpg -bordercolor "#ffffff" -splice 0x15 -density 300 -units PixelsPerInch -geometry +0+0 -gravity north /tmp/montage4.jpg
